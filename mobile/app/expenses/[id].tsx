...
const base = StyleSheet.create({
  ...
  approveBtnText: { color: '#ffffff', fontSize: 16, fontWeight: '700' },
  rejectBtn: {
    flex: 1,
    borderWidth: 1,
  ...
  rejectBtnPressed: { opacity: 0.5, backgroundColor: tokens.badBg },
  rejectBtnText: { color: tokens.bad, fontSize: 16, fontWeight: '700' },
  ...
  deleteBtnPressed: { opacity: 0.5, backgroundColor: tokens.badBg },
  deleteBtnText: { color: tokens.bad, fontSize: 15, fontWeight: '600' },
  ...
  dupLine: { color: tokens.badDeep, fontSize: 14, fontWeight: '700' },
